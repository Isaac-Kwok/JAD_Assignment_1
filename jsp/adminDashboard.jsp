...
<!-- Settle Session management later -->
<%
...
<body>
    ...
    <form action="ServiceServlet" method="post">
        ...
        <label>Service Name:</label><input type="text" name="service_name" required>
        <label>Category ID:</label><input type="number" name="category_id" required>
    ...
    <table>
        ...
        <tr>
            ...
            <td><%= description %></td>
            <td>
                <a href="ServiceServlet?action=edit&serviceId=<%= serviceId %>">Edit</a> |
    ...
    <table>
        ...
        <%	
	        // Connect to the database
	        Class.forName("com.mysql.jdbc.Driver");
	        connURL = "jdbc:mysql://localhost/cleaning_service?user=root&password=henshin111&serverTimezone=UTC";
